...
public enum NPUCraftingComponents {
	CIRCUIT {
		@Override
    ...
    PIPE {
        ...
        Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 6:
                    return new UnificationEntry(OrePrefix.pipeMedium, NPUMaterials.Enderium);
                case 7:
                    return new UnificationEntry(OrePrefix.pipeMedium, Materials.Naquadah);
                default:
                    return new UnificationEntry(OrePrefix.pipeMedium, NPUMaterials.Neutronium);
    ...
    GLASS {
        ...
        Object getIngredient(int tier) {
            switch (tier) {
                ...
                case 7:
                case 8:
                    return NPUMetaBlocks.TRANSPARENT_CASING.getItemVariant(NPUTransparentCasing.CasingType.REINFORCED_GLASS);
                default:
    ...
    PLATE {
        ...
        Object getIngredient(int tier) {
            switch (tier) {
                ...
                default:
                    return new UnificationEntry(OrePrefix.plate, NPUMaterials.Neutronium);
            }
        }
    },
    MOTOR {
