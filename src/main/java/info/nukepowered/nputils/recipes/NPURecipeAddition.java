...
//    };
	...
	public static void init() {
        ...
        // High pressure pipes
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(300).EUt(96).input(OrePrefix.pipeTiny, Materials.TungstenSteel).inputs(MetaItems.ELECTRIC_PUMP_EV.getStackForm()).circuitMeta(0).outputs(OreDictUnifier.get(OrePrefix.pipeTiny, NPUMaterials.HighPressurePipe)).buildAndRegister();
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(400).EUt(148).input(OrePrefix.pipeSmall, Materials.TungstenSteel).inputs(MetaItems.ELECTRIC_PUMP_EV.getStackForm(2)).circuitMeta(0).outputs(OreDictUnifier.get(OrePrefix.pipeSmall, NPUMaterials.HighPressurePipe)).buildAndRegister();
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(600).EUt(256).input(OrePrefix.pipeMedium, Materials.TungstenSteel).inputs(MetaItems.ELECTRIC_PUMP_IV.getStackForm()).circuitMeta(0).outputs(OreDictUnifier.get(OrePrefix.pipeMedium, NPUMaterials.HighPressurePipe)).buildAndRegister();
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(800).EUt(512).input(OrePrefix.pipeLarge, Materials.TungstenSteel).inputs(MetaItems.ELECTRIC_PUMP_IV.getStackForm(2)).circuitMeta(0).outputs(OreDictUnifier.get(OrePrefix.pipeLarge, NPUMaterials.HighPressurePipe)).buildAndRegister();
