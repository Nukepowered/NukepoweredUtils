...
public class TileEntityFisher extends TieredMetaTileEntity {
	...
	@Override
	public boolean onWrenchClick(EntityPlayer player, EnumHand hand, EnumFacing facing, CuboidRayTraceResult hitResult) {
		...
		return super.onWrenchClick(player, hand, facing, hitResult);
	}
