...
public class NPUTileEntities {
	...
	public static void init() {
        ...
        if (NPUConfig.tiers.highTierCircuitAssemblers) {
        ...
        if (NPUConfig.tiers.highTierClusterMills) {
        ...
        if (NPUConfig.gameplay.enableNaquadahReactors) {
        ...
        if (NPUConfig.enableDissabembling) {
	        ...
	        if (NPUConfig.tiers.highTierDisassemblers) {
        ...
        if (NPUConfig.tiers.highTierFishers) {
