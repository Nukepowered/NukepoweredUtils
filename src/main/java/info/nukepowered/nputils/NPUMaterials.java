...
public class NPUMaterials implements IMaterialHandler {
	...
	public static IngotMaterial NM15MSteel;
	...
	static {
	    ...
	    NM15MSteel = new IngotMaterial(991, "nm15m_stainless_steel", 0xA5ADD1, MaterialIconSet.SHINY, 3, ImmutableList.of(new MaterialStack(Materials.Iron, 32), new MaterialStack(Materials.Chrome, 9), new MaterialStack(Materials.Manganese, 8), new MaterialStack(Materials.Nickel, 2), new MaterialStack(Materials.Nitrogen, 1)), EXT_METAL | SolidMaterial.MatFlags.GENERATE_FRAME, null, 1750);
